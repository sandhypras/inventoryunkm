<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('products.create') }}" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-lg inline-flex items-center transition duration-150">
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 mb-6">
                <form method="GET" action="{{ route('products.index') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div class="flex gap-2">
                        ...
                        <a href="{{ route('products.index') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 px-4 py-2 rounded-lg">
                            Reset
                        </a>
                    </div>
                </form>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900">Rp {{ number_format($product->selling_price, 0, ',', '.') }}</div>
                                    <div class="text-xs text-gray-500">Modal: Rp {{ number_format($product->purchase_price, 0, ',', '.') }}</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span class="text-sm font-semibold {{ $product->isLowStock() ? 'text-red-600' : 'text-green-600' }}">
                                        {{ $product->stock }} {{ $product->unit }}
                                    </span>
                                    @if($product->isLowStock())
                                    <div class="text-xs text-red-500">⚠️ Stok menipis</div>
                                    @endif
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
