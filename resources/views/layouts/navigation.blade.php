            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center">
                        ...
                        <span class="ml-2 text-xl font-bold text-gray-800">Inventory UMKM</span>
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <div class="hidden sm:flex sm:items-center">
                        <x-dropdown align="left" width="48">
                            ...
                            <x-slot name="content">
                                <x-dropdown-link :href="route('stock-ins.index')">
                                    ➕ {{ __('Barang Masuk') }}
                                </x-dropdown-link>
                                <x-dropdown-link :href="route('stock-outs.index')">
                                    ➖ {{ __('Barang Keluar') }}
                                </x-dropdown-link>
                            </x-slot>
                        </x-dropdown>
